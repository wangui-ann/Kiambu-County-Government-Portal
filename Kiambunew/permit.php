...
<div id="page-wrapper" >
  <div id="page-inner">
        ...
        <div class="row text-center" style="margin-top:1%;">
          ...
          <div class="col-md-6">
            <h3><a href="welcome.php?user=<?php echo $users_id; ?>">Dashboard</a> / Parking Payment</h3>
          </div>
        </div>              
    ...
    <div class="row" style="margin-top:8%;">
      ...
      <div class="col-md-10 jumbotron" style="padding:30px;border-radius:10px;">
        <form method="POST" action="" enctype="multipart/form-data">
          <?php require 'processparking.php'; ?>
        <div class="form-group">
          <label>Enter Vehicle No <span style="color:red;">*</span></label>
          <input class="form-control" type='text' style="padding:18px;" name="ehicleNo" placeholder="Enter vehicle no">
        </div>
        <div class="form-group">
          <label> Enter Vehicle Type <span style="color:red;">*</span></label>
          <input class="form-control" type='text' style="padding:18px;" name="ehicleType" placeholder="Enter vehicle type">
        </div>
